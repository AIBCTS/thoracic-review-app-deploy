...
# Fix the escaping backslash bug:
text = text.replace(r'\}', '}')

# Remove ALL file lines (since some are my bug, some are Zotero paths).
...
# Construct brand new file containing ONLY matched entries
